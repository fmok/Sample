...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FMScrollLabel/FMScrollLabel.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FMSegmentControl/FMSegmentControl.framework"
