...
{
    if (!_segmentControl) {
        _segmentControl = [[FMSegmentControl alloc] initWithFrame:CGRectZero items:@[segmentControl_description, segmentControl_purchaseRecords] currentIndex:0 configureBlock:nil];
//        configureDic(nil, [UIColor yellowColor], [UIFont systemFontOfSize:30.f], [UIColor blackColor], [UIColor purpleColor], [UIColor blueColor], 10.f, 3.f);
